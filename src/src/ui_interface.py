...
"}")
    ...
    def retranslateUiAr(self, MainWindow):
        ...
        self.image_label_user.setText("")
        self.firstName.setPlaceholderText(QCoreApplication.translate("MainWindow", "الاسم ", None))
        self.lastName.setPlaceholderText(QCoreApplication.translate("MainWindow", " اللقب", None))
