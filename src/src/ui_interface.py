...
################################################################################
## Form generated from reading UI file 'interfaceqcxjDu.ui'
##
...
"")
        ...
        self.horizontalLayout_6.addWidget(self.membersLabel, 0, Qt.AlignmentFlag.AlignLeft)
...
"}")
    ...
    def retranslateUiEng(self, MainWindow):
        ...
        self.membersLabel.setText(QCoreApplication.translate("MainWindow", u"Members", None))
        self.showUserFormBtn.setText(QCoreApplication.translate("MainWindow", u"Add Member", None))
        self.searchUser.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Search ..", None))
        self.searchUserBtn.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Profile Page", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Settings Page", None))
        self.closeRightMenu.setText(QCoreApplication.translate("MainWindow", u"Close", None))
        self.image_label_user.setText("")
        self.firstName.setText("")
        ...
        self.email.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Email", None))
        self.phoneNb.setText("")
        self.phoneNb.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Phone Number", None))
        self.cin.setText("")
        self.cin.setPlaceholderText(QCoreApplication.translate("MainWindow", u"National ID Number", None))
        self.birthDate.setSpecialValueText("")
        self.labelProgram.setText(QCoreApplication.translate("MainWindow", u"Program:", None))
        self.program.setItemText(0, QCoreApplication.translate("MainWindow", u"Child", None))
        self.program.setItemText(1, QCoreApplication.translate("MainWindow", u"Adult", None))
        self.program.setPlaceholderText("")
        self.imageBtn.setText(QCoreApplication.translate("MainWindow", u"Choose Image", None))
        self.imageLabel.setText("")
        self.subType.setItemText(0, QCoreApplication.translate("MainWindow", u"Monthly Subscription", None))
        self.subType.setItemText(1, QCoreApplication.translate("MainWindow", u"Quarterly Subscription", None))
        self.subType.setItemText(2, QCoreApplication.translate("MainWindow", u"Semi-Annual Subscription", None))
        self.subType.setItemText(3, QCoreApplication.translate("MainWindow", u"Annual Subscription", None))
        self.subType.setItemText(4, QCoreApplication.translate("MainWindow", u"Other", None))
        self.subType.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Subscription Type", None))
        self.dureeMois.setText(QCoreApplication.translate("MainWindow", u"Duration in months:", None))
        self.labeldate.setText(QCoreApplication.translate("MainWindow", u"Start Date:", None))
        self.paymentLabel.setText(QCoreApplication.translate("MainWindow", u"Payment Method:", None))
        self.paymentMethod.setItemText(0, QCoreApplication.translate("MainWindow", u"Cash", None))
        self.paymentMethod.setItemText(1, QCoreApplication.translate("MainWindow", u"Cheque", None))
        self.paymentMethod.setPlaceholderText("")
        self.addUserBtn.setText(QCoreApplication.translate("MainWindow", u"Add User", None))
        self.controlErrorsUser.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Copyright 2024", None))
    ...
    def retranslateUiAr(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"النافذة الرئيسية", None))
        self.menuBtn.setText("")
        self.label.setText(QCoreApplication.translate("MainWindow", u"الرئيسية", None))
        self.LanguageBox.setItemText(2, QCoreApplication.translate("MainWindow", u"AR", None))

        # if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", u"تصغير", None))
        # endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("MainWindow", u"تكبير", None))
        # endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", u"إغلاق", None))
        # endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.homeBtn.setText(QCoreApplication.translate("MainWindow", u"الرئيسية", None))
        self.accountBtn.setText(QCoreApplication.translate("MainWindow", u"الملف الشخصي", None))
        self.settingsBtn.setText(QCoreApplication.translate("MainWindow", u"الإعدادات", None))
        self.aboutBtn.setText(QCoreApplication.translate("MainWindow", u"حول", None))
        self.membersLabel.setText(QCoreApplication.translate("MainWindow", u"الأعضاء", None))
        self.showUserFormBtn.setText(QCoreApplication.translate("MainWindow", u"إضافة عضو", None))
        self.searchUser.setPlaceholderText(QCoreApplication.translate("MainWindow", u"بحث ..", None))
        self.searchUserBtn.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"صفحة الملف الشخصي", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"صفحة الإعدادات", None))
        self.closeRightMenu.setText(QCoreApplication.translate("MainWindow", u"إغلاق", None))
        self.image_label_user.setText("")
        self.firstName.setText("")
        self.firstName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"الاسم الأول", None))
        self.lastName.setText("")
        self.lastName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"الاسم الأخير", None))
        self.email.setText("")
        self.email.setPlaceholderText(QCoreApplication.translate("MainWindow", u"البريد الإلكتروني", None))
        self.phoneNb.setText("")
        self.phoneNb.setPlaceholderText(QCoreApplication.translate("MainWindow", u"رقم الهاتف", None))
        self.cin.setText("")
        self.cin.setPlaceholderText(QCoreApplication.translate("MainWindow", u"رقم الهوية الوطنية", None))
        self.birthDate.setSpecialValueText("")
        self.labelProgram.setText(QCoreApplication.translate("MainWindow", u"برنامج:", None))
        self.program.setItemText(0, QCoreApplication.translate("MainWindow", u"طفل", None))
        self.program.setItemText(1, QCoreApplication.translate("MainWindow", u"بالغ", None))
        self.program.setPlaceholderText("")
        self.imageBtn.setText(QCoreApplication.translate("MainWindow", u"اختر صورة", None))
        self.imageLabel.setText("")
        self.subType.setItemText(0, QCoreApplication.translate("MainWindow", u"اشتراك شهري", None))
        self.subType.setItemText(1, QCoreApplication.translate("MainWindow", u"اشتراك ربع سنوي", None))
        self.subType.setItemText(2, QCoreApplication.translate("MainWindow", u"اشتراك نصف سنوي", None))
        self.subType.setItemText(3, QCoreApplication.translate("MainWindow", u"اشتراك سنوي", None))
        self.subType.setItemText(4, QCoreApplication.translate("MainWindow", u"أخرى", None))
        self.subType.setPlaceholderText(QCoreApplication.translate("MainWindow", u"نوع الاشتراك", None))
        self.dureeMois.setText(QCoreApplication.translate("MainWindow", u"المدة بالشهور:", None))
        self.labeldate.setText(QCoreApplication.translate("MainWindow", u"تاريخ البدء:", None))
        self.paymentLabel.setText(QCoreApplication.translate("MainWindow", u"طريقة الدفع:", None))
        self.paymentMethod.setItemText(0, QCoreApplication.translate("MainWindow", u"نقدي", None))
        self.paymentMethod.setItemText(1, QCoreApplication.translate("MainWindow", u"شيك", None))
        self.paymentMethod.setPlaceholderText("")
        self.addUserBtn.setText(QCoreApplication.translate("MainWindow", u"إضافة عضو", None))
        self.controlErrorsUser.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"حقوق الطبع والنشر 2024", None))
