...
################################################################################
## Form generated from reading UI file 'interfacecoAYyW.ui'
##
...
"}")
    ...
    def retranslateUiEng(self, MainWindow):
        ...
        self.membersLabel.setText(QCoreApplication.translate("MainWindow", "Members", None))
        self.showUserFormBtn.setText(QCoreApplication.translate("MainWindow", "Add a member", None))
        ...
        self.address.setPlaceholderText(QCoreApplication.translate("MainWindow", "Address", None))
        self.birthDate.setSpecialValueText("")
        ...
        self.subType.setItemText(2, QCoreApplication.translate("MainWindow", "Biannual Subscription", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", "Duration in months:", None))
    ...
    def retranslateUiAr(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "نافذة رئيسية", None))
        self.menuBtn.setText("")
        ...
        self.membersLabel.setText(QCoreApplication.translate("MainWindow", "الأعضاء", None))
        ...
        self.lastName.setPlaceholderText(QCoreApplication.translate("MainWindow", "الاسم الأخير", None))
        ...
        self.address.setPlaceholderText(QCoreApplication.translate("MainWindow", "العنوان", None))
        self.birthDate.setSpecialValueText("")
        ...
        self.subType.setItemText(4, QCoreApplication.translate("MainWindow", "آخر", None))
        self.subType.setPlaceholderText(QCoreApplication.translate("MainWindow", "نوع الاشتراك", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", "المدة بالشهور:", None))
