...
"")
        ...
        self.LanguageBox = QComboBox(self.frame_2)
        icon1 = QIcon()
        icon1.addFile(u":/feather/special/fr.png", QSize(), QIcon.Normal, QIcon.Off)
        self.LanguageBox.addItem(icon1, u"FR")
        icon2 = QIcon()
        icon2.addFile(u":/feather/special/eng.png", QSize(), QIcon.Normal, QIcon.Off)
        self.LanguageBox.addItem(icon2, u"ENG")
        icon3 = QIcon()
        icon3.addFile(u":/feather/special/tn.png", QSize(), QIcon.Normal, QIcon.Off)
        self.LanguageBox.addItem(icon3, "")
        self.LanguageBox.setObjectName(u"LanguageBox")
        self.LanguageBox.setMinimumSize(QSize(90, 0))
        self.LanguageBox.setMaximumSize(QSize(200, 16777215))
        ...
        icon7 = QIcon()
        icon7.addFile(u":/feather/icons/feather/home.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/feather/icons/feather/user.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/feather/icons/feather/info.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.membersFilter = QComboBox(self.frame_6)
        self.membersFilter.addItem("")
        self.membersFilter.addItem("")
        self.membersFilter.addItem("")
        self.membersFilter.setObjectName(u"membersFilter")

        self.horizontalLayout_6.addWidget(self.membersFilter, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/font_awesome/regular/icons/font_awesome/regular/square-plus.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/feather/icons/feather/search.png", QSize(), QIcon.Normal, QIcon.Off)
        self.searchUserBtn.setIcon(icon12)
...
"}")
        ...
        icon13 = QIcon()
        icon13.addFile(u":/feather/icons/feather/chevrons-right.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.cin = QLineEdit(self.frame_5)
        self.cin.setObjectName(u"cin")

        self.verticalLayout_9.addWidget(self.cin)
        ...
        self.labelBirthDate.setObjectName(u"labelBirthDate")

        self.horizontalLayout_14.addWidget(self.labelBirthDate)

        self.birthDate = QDateEdit(self.widget_8)
        self.birthDate.setObjectName(u"birthDate")
        self.birthDate.setCalendarPopup(True)

        self.horizontalLayout_14.addWidget(self.birthDate)
        ...
        self.labelProgram.setObjectName(u"labelProgram")

        self.horizontalLayout_13.addWidget(self.labelProgram)

        self.program = QComboBox(self.widget_7)
        self.program.addItem("")
        self.program.addItem("")
        self.program.setObjectName(u"program")

        self.horizontalLayout_13.addWidget(self.program)
        ...
        icon15 = QIcon(QIcon.fromTheme(u"#000000"))
        self.subType.addItem(icon15, "")
        ...
        self.dureeMois.setObjectName(u"dureeMois")

        self.horizontalLayout_10.addWidget(self.dureeMois)
        ...
        self.horizontalLayout_12.addWidget(self.paymentLabel)

        self.paymentMethod = QComboBox(self.widget_6)
        self.paymentMethod.addItem("")
        self.paymentMethod.addItem("")
        self.paymentMethod.setObjectName(u"paymentMethod")

        self.horizontalLayout_12.addWidget(self.paymentMethod, 0, Qt.AlignmentFlag.AlignRight)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/feather/icons/feather/file-plus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addUserBtn.setIcon(icon16)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LanguageBox.setItemText(2, QCoreApplication.translate("MainWindow", u"AR", None))
        ...
        self.membersFilter.setItemText(0, QCoreApplication.translate("MainWindow", u"Les membres", None))
        self.membersFilter.setItemText(1, QCoreApplication.translate("MainWindow", u"Les membres enfants", None))
        self.membersFilter.setItemText(2, QCoreApplication.translate("MainWindow", u"Les membres adultes", None))
        ...
        self.phoneNb.setText("")
        self.phoneNb.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Numero Telephone", None))
        self.cin.setText("")
        self.cin.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Num\u00e9ro carte d'identit\u00e9 national", None))
        self.labelBirthDate.setText(QCoreApplication.translate("MainWindow", u"Date de naissance :", None))
        self.birthDate.setSpecialValueText("")
        self.labelProgram.setText(QCoreApplication.translate("MainWindow", u"Programme :", None))
        self.program.setItemText(0, QCoreApplication.translate("MainWindow", u"Enfant", None))
        self.program.setItemText(1, QCoreApplication.translate("MainWindow", u"Adult", None))
        ...
        self.dureeMois.setText(QCoreApplication.translate("MainWindow", u"Dur\u00e9e en mois :", None))
        self.labeldate.setText(QCoreApplication.translate("MainWindow", u"Date de d\u00e9but :", None))
        self.paymentLabel.setText(QCoreApplication.translate("MainWindow", u"Mode de paiement:", None))
        self.paymentMethod.setItemText(0, QCoreApplication.translate("MainWindow", u"Esp\u00e8ce", None))
        self.paymentMethod.setItemText(1, QCoreApplication.translate("MainWindow", u"ch\u00e8que", None))

        self.paymentMethod.setPlaceholderText("")
    ...
    def retranslateUiEng(self, MainWindow):
        ...
        self.menuBtn.setText("")
        self.label.setText(QCoreApplication.translate("MainWindow", "Home", None))
        self.LanguageBox.setItemText(2, QCoreApplication.translate("MainWindow", "AR", None))

        # if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "Minimize", None))
        # endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "Maximize", None))
        # endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "Close", None))
        # endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.homeBtn.setText(QCoreApplication.translate("MainWindow", "Home", None))
        self.accountBtn.setText(QCoreApplication.translate("MainWindow", "Profile", None))
        self.settingsBtn.setText(QCoreApplication.translate("MainWindow", "Settings", None))
        self.aboutBtn.setText(QCoreApplication.translate("MainWindow", "About", None))
        self.membersFilter.setItemText(0, QCoreApplication.translate("MainWindow", "Members", None))
        self.membersFilter.setItemText(1, QCoreApplication.translate("MainWindow", "Child Members", None))
        self.membersFilter.setItemText(2, QCoreApplication.translate("MainWindow", "Adult Members", None))

        self.showUserFormBtn.setText(QCoreApplication.translate("MainWindow", "Add Member", None))
        self.searchUser.setPlaceholderText(QCoreApplication.translate("MainWindow", "Search ..", None))
        self.searchUserBtn.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", "Profile Page", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", "Settings Page", None))
        self.closeRightMenu.setText(QCoreApplication.translate("MainWindow", "Close", None))
        self.image_label_user.setText("")
        self.firstName.setText("")
        self.firstName.setPlaceholderText(QCoreApplication.translate("MainWindow", "First Name", None))
        self.lastName.setText("")
        self.lastName.setPlaceholderText(QCoreApplication.translate("MainWindow", "Last Name", None))
        self.email.setText("")
        self.email.setPlaceholderText(QCoreApplication.translate("MainWindow", "Email", None))
        self.phoneNb.setText("")
        self.phoneNb.setPlaceholderText(QCoreApplication.translate("MainWindow", "Phone Number", None))
        self.cin.setText("")
        self.cin.setPlaceholderText(QCoreApplication.translate("MainWindow", "National ID Number", None))
        self.labelBirthDate.setText(QCoreApplication.translate("MainWindow", "Date of Birth:", None))
        self.birthDate.setSpecialValueText("")
        self.labelProgram.setText(QCoreApplication.translate("MainWindow", "Program:", None))
        self.program.setItemText(0, QCoreApplication.translate("MainWindow", "Child", None))
        self.program.setItemText(1, QCoreApplication.translate("MainWindow", "Adult", None))

        self.program.setPlaceholderText("")
        self.imageBtn.setText(QCoreApplication.translate("MainWindow", "Choose Image", None))
        self.imageLabel.setText("")
        self.subType.setItemText(0, QCoreApplication.translate("MainWindow", "Monthly Subscription", None))
        self.subType.setItemText(1, QCoreApplication.translate("MainWindow", "Quarterly Subscription", None))
        self.subType.setItemText(2, QCoreApplication.translate("MainWindow", "Semi-Annual Subscription", None))
        self.subType.setItemText(3, QCoreApplication.translate("MainWindow", "Annual Subscription", None))
        self.subType.setItemText(4, QCoreApplication.translate("MainWindow", "Other", None))

        self.subType.setPlaceholderText(QCoreApplication.translate("MainWindow", "Subscription Type", None))
        self.dureeMois.setText(QCoreApplication.translate("MainWindow", "Duration in Months:", None))
        self.labeldate.setText(QCoreApplication.translate("MainWindow", "Start Date:", None))
        self.paymentLabel.setText(QCoreApplication.translate("MainWindow", "Payment Method:", None))
        self.paymentMethod.setItemText(0, QCoreApplication.translate("MainWindow", "Cash", None))
        self.paymentMethod.setItemText(1, QCoreApplication.translate("MainWindow", "Check", None))

        self.paymentMethod.setPlaceholderText("")
        self.addUserBtn.setText(QCoreApplication.translate("MainWindow", "Add User", None))
        self.controlErrorsUser.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", "Copyright 2024", None))

    def retranslateUiAr(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "نافذة الرئيسية", None))
        self.menuBtn.setText("")
        self.label.setText(QCoreApplication.translate("MainWindow", "الرئيسية", None))
        self.LanguageBox.setItemText(2, QCoreApplication.translate("MainWindow", "العربية", None))

        # if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "تصغير", None))
        # endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "تكبير", None))
        # endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
        # if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("MainWindow", "إغلاق", None))
        # endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.homeBtn.setText(QCoreApplication.translate("MainWindow", "الرئيسية", None))
        self.accountBtn.setText(QCoreApplication.translate("MainWindow", "الملف الشخصي", None))
        self.settingsBtn.setText(QCoreApplication.translate("MainWindow", "الإعدادات", None))
        self.aboutBtn.setText(QCoreApplication.translate("MainWindow", "حول", None))
        self.membersFilter.setItemText(0, QCoreApplication.translate("MainWindow", "الأعضاء", None))
        self.membersFilter.setItemText(1, QCoreApplication.translate("MainWindow", "أعضاء الأطفال", None))
        self.membersFilter.setItemText(2, QCoreApplication.translate("MainWindow", "أعضاء الكبار", None))

        self.showUserFormBtn.setText(QCoreApplication.translate("MainWindow", "إضافة عضو", None))
        self.searchUser.setPlaceholderText(QCoreApplication.translate("MainWindow", "بحث ..", None))
        self.searchUserBtn.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", "صفحة الملف الشخصي", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", "صفحة الإعدادات", None))
        self.closeRightMenu.setText(QCoreApplication.translate("MainWindow", "إغلاق", None))
        self.image_label_user.setText("")
        self.firstName.setText("")
        self.firstName.setPlaceholderText(QCoreApplication.translate("MainWindow", "الاسم الأول", None))
        self.lastName.setText("")
        self.lastName.setPlaceholderText(QCoreApplication.translate("MainWindow", "اسم العائلة", None))
        self.email.setText("")
        self.email.setPlaceholderText(QCoreApplication.translate("MainWindow", "البريد الإلكتروني", None))
        self.phoneNb.setText("")
        self.phoneNb.setPlaceholderText(QCoreApplication.translate("MainWindow", "رقم الهاتف", None))
        self.cin.setText("")
        self.cin.setPlaceholderText(QCoreApplication.translate("MainWindow", "رقم بطاقة الهوية الوطنية", None))
        self.labelBirthDate.setText(QCoreApplication.translate("MainWindow", "تاريخ الميلاد:", None))
        self.birthDate.setSpecialValueText("")
        self.labelProgram.setText(QCoreApplication.translate("MainWindow", "برنامج:", None))
        self.program.setItemText(0, QCoreApplication.translate("MainWindow", "طفل", None))
        self.program.setItemText(1, QCoreApplication.translate("MainWindow", "بالغ", None))

        self.program.setPlaceholderText("")
        self.imageBtn.setText(QCoreApplication.translate("MainWindow", "اختر صورة", None))
        self.imageLabel.setText("")
        self.subType.setItemText(0, QCoreApplication.translate("MainWindow", "اشتراك شهري", None))
        self.subType.setItemText(1, QCoreApplication.translate("MainWindow", "اشتراك ربع سنوي", None))
        self.subType.setItemText(2, QCoreApplication.translate("MainWindow", "اشتراك نصف سنوي", None))
        self.subType.setItemText(3, QCoreApplication.translate("MainWindow", "اشتراك سنوي", None))
        self.subType.setItemText(4, QCoreApplication.translate("MainWindow", "أخرى", None))

        self.subType.setPlaceholderText(QCoreApplication.translate("MainWindow", "نوع الاشتراك", None))
        self.dureeMois.setText(QCoreApplication.translate("MainWindow", "المدة بالأشهر:", None))
        self.labeldate.setText(QCoreApplication.translate("MainWindow", "تاريخ البداية:", None))
        self.paymentLabel.setText(QCoreApplication.translate("MainWindow", "طريقة الدفع:", None))
        self.paymentMethod.setItemText(0, QCoreApplication.translate("MainWindow", "نقدًا", None))
        self.paymentMethod.setItemText(1, QCoreApplication.translate("MainWindow", "شيك", None))

        self.paymentMethod.setPlaceholderText("")
        self.addUserBtn.setText(QCoreApplication.translate("MainWindow", "إضافة مستخدم", None))
        self.controlErrorsUser.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", "حقوق الطبع والنشر 2024", None))
